...
func NewErrPublishingToDocIDTopic(inner error, cid, key string, kv ...errors.KV) error {
	return errors.Wrap(fmt.Sprintf(errPublishingToDocIDTopic, cid, key), inner, kv...)
}
