...
func (_m *Collection) DeleteWithKey(_a0 context.Context, _a1 client.DocID) (*client.DeleteResult, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *Collection_DeleteWithKey_Call) Run(run func(_a0 context.Context, _a1 client.DocID)) *Collection_DeleteWithKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(client.DocID))
	})
	return _c
...
func (_c *Collection_DeleteWithKey_Call) RunAndReturn(run func(context.Context, client.DocID) (*client.DeleteResult, error)) *Collection_DeleteWithKey_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteWithKeys provides a mock function with given fields: _a0, _a1
func (_m *Collection) DeleteWithKeys(_a0 context.Context, _a1 []client.DocID) (*client.DeleteResult, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *Collection_DeleteWithKeys_Call) Run(run func(_a0 context.Context, _a1 []client.DocID)) *Collection_DeleteWithKeys_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]client.DocID))
	})
	return _c
...
func (_c *Collection_DeleteWithKeys_Call) RunAndReturn(run func(context.Context, []client.DocID) (*client.DeleteResult, error)) *Collection_DeleteWithKeys_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Collection) Get(ctx context.Context, key client.DocID, showDeleted bool) (*client.Document, error) {
...
func (_c *Collection_Get_Call) Run(run func(ctx context.Context, key client.DocID, showDeleted bool)) *Collection_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *Collection) GetAllDocIDs(ctx context.Context) (<-chan client.DocIDsResult, error) {
	ret := _m.Called(ctx)

	var r0 <-chan client.DocIDsResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (<-chan client.DocIDsResult, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) <-chan client.DocIDsResult); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan client.DocIDsResult)
		}
	}
...
func (_c *Collection_GetAllDocIDs_Call) Return(_a0 <-chan client.DocIDsResult, _a1 error) *Collection_GetAllDocIDs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Collection_GetAllDocIDs_Call) RunAndReturn(run func(context.Context) (<-chan client.DocIDsResult, error)) *Collection_GetAllDocIDs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Collection) UpdateWithKey(ctx context.Context, key client.DocID, updater string) (*client.UpdateResult, error) {
...
func (_c *Collection_UpdateWithKey_Call) Run(run func(ctx context.Context, key client.DocID, updater string)) *Collection_UpdateWithKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Collection_UpdateWithKey_Call) RunAndReturn(run func(context.Context, client.DocID, string) (*client.UpdateResult, error)) *Collection_UpdateWithKey_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateWithKeys provides a mock function with given fields: _a0, _a1, _a2
func (_m *Collection) UpdateWithKeys(_a0 context.Context, _a1 []client.DocID, _a2 string) (*client.UpdateResult, error) {
...
func (_c *Collection_UpdateWithKeys_Call) Run(run func(_a0 context.Context, _a1 []client.DocID, _a2 string)) *Collection_UpdateWithKeys_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]client.DocID), args[2].(string))
	})
	return _c
...
func (_c *Collection_UpdateWithKeys_Call) RunAndReturn(run func(context.Context, []client.DocID, string) (*client.UpdateResult, error)) *Collection_UpdateWithKeys_Call {
	_c.Call.Return(run)
	return _c
}
